...
def repartition(
    ...
    A = "alpha"
    B = "alpha_complement"
    labels = np.unique(np.array(partition))
...
def colormap_shape_diameter_function(mesh: Trimesh, sdf_values) -> Trimesh:
    """ """
...
def colormap_partition(mesh: Trimesh, partition) -> Trimesh:
    """ """
...
def partition2label(mesh: Trimesh, partition):
    """ """
...
def segment_mesh_sdf(filename: Path | str, config, extension="glb") -> Trimesh:
    """ """
