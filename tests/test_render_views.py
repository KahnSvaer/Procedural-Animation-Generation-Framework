...
TEST_MODEL_PATH = "./generated_data/models/img_mesh_Goldfish.glb"
...
def test_render_views_returns_expected_views():
    ...
    for vals in test_vals:
        ...
        views, _, _ = render_views(mesh, num_views=num_views, vertical_angles=vertical_angles)
